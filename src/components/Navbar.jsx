...
const Navbar = () => {
  return (
    <div className="navbar bg-white sticky top-0 z-50 border-b border-gray-100 px-4 lg:px-8">
      <div className="navbar-start w-1/2 lg:w-1/3 flex items-center">
        ...
        {/* Mobile Logo */}
        <a className="flex lg:hidden items-center gap-1.5 ml-1 hover:opacity-80 transition-opacity cursor-pointer">
      ...
      <div className="navbar-end flex gap-2 w-1/2 lg:w-1/3 justify-end">
