      ...
      <div className="max-w-7xl mx-auto flex flex-row items-center justify-between px-4 lg:px-8 gap-4 sm:gap-8 lg:gap-12">
        <div className="text-left flex-1 min-w-0">
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-extrabold leading-tight tracking-tight text-[#1a1a2e]">
            Build Your Ideal <br/>
            <span className="bg-gradient-to-r from-pink-500 to-purple-500 bg-clip-text text-transparent">Development Stack</span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row justify-start gap-2 sm:gap-4">
            <button className="bg-gradient-to-r from-pink-500 to-purple-500 text-white border-none rounded-lg px-4 sm:px-8 py-2.5 sm:py-3.5 font-semibold text-xs sm:text-sm hover:opacity-90 transition-opacity whitespace-nowrap">Explore Technologies</button>
